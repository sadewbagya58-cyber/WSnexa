    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 max-w-md w-full text-center space-y-4 shadow-2xl">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-black text-white uppercase tracking-wider">Unable to Load Pending Access Page</h2>
          <p className="text-xs text-zinc-400">
            {error.message || 'A temporary error occurred while checking your authorization status.'}
          </p>
        </div>
