    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold tracking-tight text-zinc-950">Add Single Table</h1>
        ...
        <Card className="p-8 text-center space-y-4">
          <p className="text-sm text-zinc-600">
            You must create at least one Service Area before adding dining tables.
          </p>
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-zinc-950">Add Single Table</h1>
          <p className="text-xs text-zinc-500">Create an individual dining table.</p>
        </div>
