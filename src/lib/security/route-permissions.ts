...
export const ROUTE_PERMISSION_MAP: RoutePermissionConfig[] = [
  ...
  { prefix: '/dashboard/inventory/counts', permission: ['inventory.counts.manage', 'inventory.counts.approve', 'inventory.view'] },
  ...
  { prefix: '/dashboard/inventory/locations', permission: ['inventory.locations.manage', 'inventory.view'] },
  { prefix: '/dashboard/inventory/recipes', permission: ['recipes.view', 'recipes.manage', 'recipes.costs.view', 'inventory.view'] },
  { prefix: '/dashboard/inventory/purchasing', permission: ['purchasing.view', 'purchasing.create', 'purchasing.approve', 'purchasing.receive', 'inventory.view'] },
  { prefix: '/dashboard/inventory/suppliers', permission: ['suppliers.view', 'suppliers.manage', 'inventory.view'] },
