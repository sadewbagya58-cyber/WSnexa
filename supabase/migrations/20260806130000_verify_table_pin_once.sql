-- Migration: 20260806130000_verify_table_pin_once.sql
-- Description: Private Service-Role Guest Order RPC with p_table_access_verified flag.
-- Removes duplicate PIN hash checking inside checkout RPC and revokes anon access for security.

-- First drop the old function signature if it exists with p_pin_hash
...
-- Only service_role (used by Next.js Server Action with createAdminClient) can execute create_guest_order.
