  ...
  LOOP
    ...
    IF v_cart_item ? 'selectedModifiers' AND jsonb_array_length(v_cart_item->'selectedModifiers') > 0 THEN
      ...
      LOOP
        ...
        -- 8.1 Fetch Option & Validate against real columns: modifier_group_id, additional_price_cents, is_active
        ...
        -- 8.2 Fetch Group & Validate menu_item_id, branch_id, business_id
    ...
    -- 8.3 Validate Group Selection Limits
    FOR v_group IN
